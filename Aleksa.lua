...
-- Версия 1.1 – с новым API-ключом и моделью
-- ============================================================
...
-- ===== НАСТРОЙКИ (НОВЫЙ КЛЮЧ) =====
local GROQ_API_KEY = "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"
local GROQ_MODEL = "llama-3.3-70b-versatile"  -- актуальная модель
